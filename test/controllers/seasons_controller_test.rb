...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { description: @season.description, image_url: @season.image_url, serial_id: @season.serial_id, story: @season.story }
    end
  ...
  test "should update season" do
    patch :update, id: @season, season: { description: @season.description, image_url: @season.image_url, serial_id: @season.serial_id, story: @season.story }
    assert_redirected_to season_path(assigns(:season))
  end
